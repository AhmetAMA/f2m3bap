...
// your data
String studentName = "Ahmet"; // jouw student nummer + naam
...
void handleRoot() {server.send(200, "text/html", "<h3>Groetjesvan DuurzaamHuis! mijnnaam is: " +  studentName+  
 ...
 */
  ...
  server.on("/led2", [](){
       if(!led2Status && !digitalRead(Led1)){
